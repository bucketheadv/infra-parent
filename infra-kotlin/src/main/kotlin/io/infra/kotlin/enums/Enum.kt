...
inline fun <reified E> enumFromCode(code: Number): E? where E : Enum<E>, E : NumberCodeEnum {
    return enumByCode(code)
}

inline fun <reified E> enumFromCode(code: String): E? where E : Enum<E>, E : StringCodeEnum {
    return enumByCode(code)
}